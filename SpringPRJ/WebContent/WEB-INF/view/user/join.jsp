                           ...
                           <div class="col-xs-12 col-sm-12">
                              <div class="input-field message">
                                 <div class="check_styl">
                                    <p>나의 알레르기(복수선택)</p>
                                    <input type="checkbox" name="allergy1" value="Crustacean"> 갑각류
                                    <input type="checkbox" name="allergy2" value="Egg"> 달걀
                                    <input type="checkbox" name="allergy3" value="Peanut"> 땅콩
                                    <input type="checkbox" name="allergy4" value="Wheat"> 밀
                                    <input type="checkbox" name="allergy5" value="Fish"> 생선
                                    <input type="checkbox" name="allergy6" value="Milk"> 우유
                                    <input type="checkbox" name="allergy7" value="Clam"> 조개
                                    <input type="checkbox" name="allergy8" value="Bean"> 콩
